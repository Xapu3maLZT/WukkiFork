...
class SelectGames(disnake.ui.Select):
    def __init__(self):
        options = [
            disnake.SelectOption(label="Dota 2", value="1069157308388614144", emoji="<:dota:1070792276793626715>"),
            disnake.SelectOption(label="Valorant", value="1069157349564100629",
                                 emoji="<:valorant:1070792273102651584>"),
            disnake.SelectOption(label="Genshin Impact", value="1070712380692111410",
...
class GameRoles(commands.Cog):
    ...
    async def on_connect(self):
        ...
        view = disnake.ui.View(timeout=None)
        view.add_item(SelectGames())
        self.bot.add_view(view, message_id=1079643628256890990)

def setup(bot):
    bot.add_cog(SelectGames(bot))
